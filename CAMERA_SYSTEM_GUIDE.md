...
const myPreset: CameraPresetConfig = {
  ...
  lookAt: [0, 0, 0],
  fov: 50,
  movement: { stiffness: 150, damping: 16, mass: 1, maxSpeed: 60, acceleration: 12, deceleration: 14 },
...
```typescript
export type TransitionType = "fade" | "zoom" | "orbit" | "dolly" | "portal" | "custom" | "myTransition";
```
